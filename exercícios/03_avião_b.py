...
def evaluate(individual):
    ...
    dif1 = (peso1 - compartimentos[0][1]) / compartimentos[0][1]
    dif2 = (peso2 - compartimentos[1][1]) / compartimentos[0][1]
    dif3 = (peso2 - compartimentos[2][1]) / compartimentos[0][1]

    sqr_diff = dif1**2 + dif2**2 + dif3**2

    return lucro, sqr_diff
